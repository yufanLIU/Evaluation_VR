...
function varargout = IVQUESTUI(varargin)
%IVQUESTUI M-file for IVQUESTUI.fig
%      IVQUESTUI, by itself, creates a new IVQUESTUI or raises the existing
%      singleton*.
%
%      H = IVQUESTUI returns the handle to a new IVQUESTUI or the handle to
%      the existing singleton*.
%
%      IVQUESTUI('Property','Value',...) creates a new IVQUESTUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to IVQUESTGUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      IVQUESTUI('CALLBACK') and IVQUESTUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in IVQUESTUI.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help IVQUESTUI

% Last Modified by GUIDE v2.5 17-Nov-2009 13:36:22

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @IVQUESTUI_OpeningFcn, ...
                   'gui_OutputFcn',  @IVQUESTUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before IVQUESTUI is made visible.
function IVQUESTUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for IVQUESTUI
clc
handles.output = [];
guidata(handles.IVQUESTUI,handles);
...
function varargout = IVQUESTUI_OutputFcn(hObject, eventdata, handles)
...
% --- Executes when user attempts to close IVQUESTUI.
function IVQUESTUI_CloseRequestFcn(hObject, eventdata, handles)
% hObject    handle to IVQUESTUI (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%OptionsTab={'SubjectiveOptions','GeneralOptions'};
%handles.ToolOptions=Options(handles.ToolOptions,OptionsTab{1});
%guidata(handles.IVQUESTUI,handles);
